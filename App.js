...
export default function App() {
  ...
  const addEmployee = () => {
    fetch("https://dummy.restapiexample.com/api/v1/create", {
      ...
      .then((json) => {
        ToastAndroid.show(
          "Created employee with id: " + json.data.id,
          ToastAndroid.SHORT
        );
      });
  };
  ...
  const updateEmployee = () => {
    fetch(`https://dummy.restapiexample.com/api/v1/update/${id}`, {
      ...
      .then((json) => {
        console.log(json);
        ToastAndroid.show("Updated employee", ToastAndroid.SHORT);
      });
  };
  ...
  const deleteEmployee = () => {
    fetch(`https://dummy.restapiexample.com/api/v1/delete/${id}`, {
      ...
      ToastAndroid.show("Deleted employee", ToastAndroid.SHORT);
    });
  };

  return (
    <View style={styles.container}>
      {showMethod === null && <Text style={styles.header}>Application Programming Interface</Text>}
      {showMethod === "GET" && (
